...
<body>
	...
	<div class = "container-fluid">
		...
		<div class = "container">
			...
			<h2 id="description"> Supprimer Items</h2>
			<hr class="separateur">
			...
			<div class="row">
    			<div class="col" style="background-color:white;">
    				Livres
    				<ul>
    					<li>Emy <img src="supp.png" class="img-fluid" height = "10" width="10">  </li>
    					<li>Laure <img src="supp.png" class="img-fluid" height = "10" width="10">  </li>
    					<li>Alexis <img src="supp.png" class="img-fluid" height = "10" width="10">  </li>
    					<li>Paul <img src="supp.png" class="img-fluid" height = "10" width="10">  </li>
  	   				</ul>
				</div>
