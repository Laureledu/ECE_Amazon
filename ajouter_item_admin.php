...
<!DOCTYPE html>
    <meta charset="utf-8">
	<title>Ajouter un item par l'Administrateur</title>
        ...
        <div class = "row">
            <!-- Colonne-centree est contenu dans le CSS et permet de mettre tout le contenu au centre de la ligne-->
				...
				<div class = "col-md-5 colonne-centree">
					<!-- Default form login -->
					<form class="text-center border border-light p-6" action="traitement_ajout_item_admin.php" method="POST">

					    <p class="h4 mb-4">Ajout d'item</p>

                        <!-- Vendeur --> 
                        <div class ="form-group">
                            <label for="inputEmail4">Identifiant du vendeur de l'item</label>
                            <input type="text" class="form-control" name="id_vendeur_item" placeholder="Identifiant du vendeur" required>
                        </div>
